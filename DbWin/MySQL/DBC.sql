...
REPLACE INTO `codici` (`cod`, `mod`, `descrizione`, `id_utente`, `creazione`, `aggiornamento`, `id_ultimo`) VALUES
	...
	('201.10.900', 'b', 'SCHEMA EXTRA', 6, '2025-02-06 06:48:21', '2025-02-08 07:44:37', 6),
...
-- Dump dei dati della tabella dbc00.schemi: ~12 rows (circa)
...
SET nImp = dbc01._NumImpieghi(_cod, _mod);
SET nLeg = dbc01._NumLegami(_cod, _mod);
IF n = 1 THEN
...
IF _stx = 2 THEN
	...
	IF x = 0 THEN
		...
		SET n = 1;
	ELSEIF x = 1 THEN	
		-- UPDATE materiali SET ... WHERE materiali.materiale = _mat;
		SET n = 1; 
	ELSE
		SET n = -1;
	END IF;
...
-- Dump della struttura del database dbc01r
...
REPLACE INTO `utenti` (`id`, `utente`, `utenteSQL`, `sigla`, `password`, `can_write`) VALUES
	...
	(2, 'pluto', 'pluto@localhost', 'PLU', NULL, 1),
